...
<html class="no-js" lang="fa" dir="rtl">
  <head>
    ...
    <!-- Site Title -->
    <title>Resome - Info Abolfazl noori</title>
        ...
        <div class="row">
          <div class="navbarecastom col-12 d-flex flex-wrap align-items-center">
            ...
            <div class="header-info-list d-none d-md-inline-block">
              <ul class="ul-reset">
                <li>
                  <a href="mailto:Abolnoori2929@gmail.com"
                    >Abolnoori2929@gmail.com</a
                  >
                </li>
              </ul>
            </div>
            ...
            <div class="header-button">
              <div class="button-dark-light">
                <a href="/fa"
                  ><img src="assets/img/icons/usa.svg" alt=""
                /></a>
              </div>
          ...
          <div class="row align-items-center">
            <div class="col-md-6">
              <div class="hero-content-box">
                <span class="hero-sub-title">I am Abolfazl</span>
                <h1 class="hero-title">Programmer +<br />Backend Developer</h1>
                ...
                <p class="lead">
                  Given my educational background, I can easily solve users'
                  complex problems in the field of computers and programming.
                </p>
          ...
          <div class="col-md-12 text-center">
            ...
            <div class="copy-text">
              <p>
                ...
                <a href="#" target="_blank">ThemeJunction</a>
              </p>
            </div>
          </div>
        </div>
